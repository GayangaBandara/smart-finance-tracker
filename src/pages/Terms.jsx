          ...
          <div className="prose max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                under your account. You agree not to disclose your password to any third party and
                to take sole responsibility for activities that occur under your account.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800 mb-3">7. Service Availability</h2>
              <p className="text-gray-700">
