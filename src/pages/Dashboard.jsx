  ...
  return (
    <div className="container mx-auto px-4 py-6 md:px-6 md:py-8 lg:px-8 lg:py-10 xl:px-12 xl:py-12 2xl:px-16 2xl:py-16 space-y-6 md:space-y-8 lg:space-y-10 xl:space-y-12">
      <div className="bg-white p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 rounded-2xl shadow-xl border border-gray-200">
        <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold text-gray-800">
          Dashboard
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          ...
          <div
            className={`p-4 rounded-xl border ${netBalance >= 0 ? 'bg-blue-50 border-blue-200' : 'bg-orange-50 border-orange-200'}`}
          >
            <p
              className={`text-sm md:text-base lg:text-lg ${netBalance >= 0 ? 'text-blue-600' : 'text-orange-600'}`}
            >
              Net Balance
            </p>
            <p
              className={`text-xl md:text-2xl lg:text-3xl font-bold ${netBalance >= 0 ? 'text-blue-600' : 'text-orange-600'}`}
            >
